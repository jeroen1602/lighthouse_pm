...
class TestColumn {
  ...
  bool compare(TestColumn truth, [bool shouldThrow = true]) {
    bool nameIncorrect = this.columnName != truth.columnName;
    bool typeIncorrect = this.type != truth.type;
...
class TestSchema {
  ...
  bool compare(TestSchema truth, [bool shouldThrow = true]) {
    ...
    for (final table in this.testTables) {
      if (truth.testTables
