...
class MaterialTestPage extends BasePage with WithBlocStateless {
  ...
  Widget createBlock(
    ...
    final Color text,
    final String name,
    final TextStyle baseTheme,
  ) {
    return Container(
      color: background,
      child: Text(name, style: baseTheme.copyWith(color: text)),
    );
  }

  List<Widget> _createOnBlock(
  ...
  List<Widget> _createCustomBlocks(
    ...
    return [
      ..._createOnBlock(
        colorScheme.booting,
        colorScheme.onBooting,
        "booting",
        baseTheme,
      ),
      ..._createOnBlock(
        colorScheme.bootingContainer,
        colorScheme.onBootingContainer,
        "bootingContainer",
        baseTheme,
      ),
      ..._createOnBlock(
        colorScheme.standby,
        colorScheme.onStandby,
        "standby",
        baseTheme,
      ),
      ..._createOnBlock(
        colorScheme.standbyContainer,
        colorScheme.onStandbyContainer,
        "standbyContainer",
        baseTheme,
      ),
      ..._createOnBlock(
      ...
      ..._createOnBlock(
        colorScheme.sleepContainer,
        colorScheme.onSleepContainer,
        "sleepContainer",
        baseTheme,
      ),
  ...
  List<Widget> _createGridView(
    ...
    return [
      Text(name, style: theming.headlineMedium),
      Expanded(
  ...
  List<Widget> _createMaterialColorScheme(
    ...
    return _createGridView(
      name,
      _createBlocks(theming.bodyMedium!, colorScheme),
      theming,
    );
  }

  List<Widget> _createCustomColorScheme(
    final String name,
    ...
    return _createGridView(
      name,
      _createCustomBlocks(theming.bodyMedium!, customColors),
      theming,
    );
  }
      ...
      body: Column(
        ...
        children: [
          ...
          ..._createCustomColorScheme(
            "Light custom color scheme",
            lightCustomColors,
            theming,
          ),
          ..._createCustomColorScheme(
            "Dark custom color scheme",
            darkCustomColors,
            theming,
          ),
        ],
