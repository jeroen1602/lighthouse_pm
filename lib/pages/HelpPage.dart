                    ...
                    _HelpItem(
                        ...
                        body: RichText(
                          text: TextSpan(style: textTheme, children: [
                            ...
                            TextSpan(
                                text:
                                    ' the group header to select the group. '),
                            TextSpan(
                            ...
                            TextSpan(
                                text:
                                    'To remove a group first follow the first '
                                    'steps of '),
                            ...
                            TextSpan(
                                text:
                                    ' and confirm that you want to remove the '
                                    'group.\nThe items in the group will automatically '
                                    'be removed.'),
                          ]),
                        )),
                    if (LighthouseProvider.instance.getPairBackEnds().length >
                        0)
                      _HelpItem(
                          ...
                          body: RichText(
                            text: TextSpan(style: textTheme, children: [
                              ...
                              TextSpan(text: 'Pair', style: textThemeBold),
                              TextSpan(
                                  text:
                              ...
                              TextSpan(text: 'LHB-', style: textThemeBold),
                              TextSpan(text: '.\n'),
                              if (settings?.viveBaseStationsEnabled ==
                                  true) ...[
                                TextSpan(
                                    text:
                                        'Vive base stations should start with '),
                                TextSpan(text: 'HTC BS', style: textThemeBold),
                                TextSpan(text: '.'),
                              ],
                            ]),
                          )),
