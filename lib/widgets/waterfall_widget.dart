...
typedef DownStreamBuilder<T> =
    WaterfallStreamWidget<T> Function(
      BuildContext,
      List<Object?> upStream,
      List<Object> downStreamBuilders,
    );
...
abstract class WaterfallStreamWidget<T> extends StatelessWidget {
  ...
  WaterfallStreamWidget getNextStreamDown(
    ...
    final T? upstreamData,
  ) {
    if (downStreamBuilders.isEmpty) {
      throw Exception(
        "Down stream builders shouldn't be empty if you want to "
